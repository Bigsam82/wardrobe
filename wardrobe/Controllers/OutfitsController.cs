...
namespace wardrobe.Controllers
{
    ...
    {
        private Outfit1Entities db = new Outfit1Entities();
        ...
        {
            ViewBag.Accessories = new SelectList(db.Accessories, "AccessoriesID", "Name");
            ViewBag.BottomID = new SelectList(db.Bottoms, "BottomID", "Name");
            ViewBag.ShoesID = new SelectList(db.Shoes, "ShoeID", "Name");
        ...
        public ActionResult Create([Bind(Include = "OutfitID,TopID,BottomID,ShoesID,Accessories")] Outfit outfit)
        {
            ...
            ViewBag.Accessories = new SelectList(db.Accessories, "AccessoriesID", "Name", outfit.Accessories);
            ViewBag.BottomID = new SelectList(db.Bottoms, "BottomID", "Name", outfit.BottomID);
            ViewBag.ShoesID = new SelectList(db.Shoes, "ShoeID", "Name", outfit.ShoesID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,TopID,BottomID,ShoesID,Accessories")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
